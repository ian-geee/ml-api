...
def run_pipeline() -> None:
    ...
    data_folder = make_output_dir(output="scripts/house/runs/custom_runs/" + cross_run_id + "/data")
    model_folder = make_output_dir(output="scripts/house/runs/custom_runs/" + cross_run_id + "/models")
    eval_folder = make_output_dir(output="scripts/house/runs/custom_runs/" + cross_run_id + "/eval")
